...
fun Int.toByteArray() = ByteArray(Int.SIZE_BYTES) { i -> (this shr (i * Byte.SIZE_BITS)).toByte() }

class SecureRNG(seed: Int) : Random() {
  // We need access to protected method SecureRandom.next
